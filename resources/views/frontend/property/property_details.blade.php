            ...
            <div class="right-column pull-right clearfix">
                <div class="price-inner clearfix">
                    ...
                    <div class="price-box pull-right">
                        <h3>{{ currency_gnf($property->lowest_price ?? $property->max_price) }}</h3>
                    </div>
                </div>
                    ...
                    <div class="carousel-inner">
                        <div class="single-item-carousel owl-carousel owl-theme owl-nav-none owl-dot-style-one">
                            <figure class="image-box">
                                <img src="{{ asset($property->property_thumbnail) }}" alt="{{ $property->property_name }}" style="width:100%; height:500px; object-fit:cover;">
                            </figure>

                            @foreach($property->propertyImages as $img)
                            <figure class="image-box">
                                <img src="{{ asset($img->photo_name) }}" alt="{{ $property->property_name }} - Image {{ $loop->iteration }}" style="width:100%; height:500px; object-fit:cover;">
                            </figure>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="location-box content-widget">
                        ...
                        <div class="google-map-area">
                            <div 
                                ...
                                data-map-title="{{ $property->city ?? 'Conakry, Guinée' }}" 
                                style="height: 400px;">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 feature-block">
                                <div class="feature-block-one">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <figure class="image"><img src="{{ asset($item->property_thumbnail) }}" alt="{{ $item->property_name }}" style="width:370px; height:250px;"></figure>
                                        ...
                                        <div class="lower-content">
                                            ...
                                            <div class="price-box clearfix">
                                                <div class="price-info">
                                                    <h6>Prix</h6>
                                                    <h4>{{ currency_gnf($item->lowest_price ?? $item->max_price) }}</h4>
                                                </div>
                                            </div>
                    ...
                    <div class="calculator-widget sidebar-widget">
                        ...
                        <form action="#" method="post" class="default-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="price" placeholder="Prix (GNF)" value="{{ $property->lowest_price }}">
                            </div>
                            <div class="form-group">
                                <i class="fas fa-money-bill"></i>
                                <input type="text" name="down_payment" placeholder="Apport initial (GNF)">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="loan_term" placeholder="Durée du prêt (années)">
                            </div>
                            <div class="form-group">
