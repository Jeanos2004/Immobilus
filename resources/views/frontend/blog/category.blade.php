                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="text-center">
                                <h3>{{ __('Aucun article trouvé dans cette catégorie') }}</h3>
                                <p>{{ __('Revenez bientôt pour découvrir nos nouveaux articles.') }}</p>
                    ...
                    <div class="sidebar-widget category-widget">
                        ...
                        <div class="widget-content">
                            <ul class="category-list clearfix">
                                ...
                                <li><a href="{{ route('blog.category', $cat->slug) }}" class="{{ $cat->id == $category->id ? 'active' : '' }}">{{ $cat->name }} <span>({{ $cat->posts->count() }})</span></a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
