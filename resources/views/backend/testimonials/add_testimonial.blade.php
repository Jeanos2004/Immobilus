    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Ajouter un témoignage</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Formulaire d'ajout de témoignage</h4>
                        ...
                        <form method="post" action="{{ route('store.testimonial') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="name" class="form-control" type="text" id="name" placeholder="Nom du client" value="{{ old('name') }}" required>
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="position" class="form-control" type="text" id="position" placeholder="Poste ou fonction" value="{{ old('position') }}" required>
                                    @error('position')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="message" class="form-control" id="message" rows="5" placeholder="Témoignage du client" required>{{ old('message') }}</textarea>
                                    @error('message')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="rating" class="form-select" id="rating" required>
                                        ...
                                        <option value="5" {{ old('rating') == 5 ? 'selected' : '' }} selected>5 étoiles</option>
                                    </select>
                                    @error('rating')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @enderror
                                    <div class="mt-3">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ url('upload/no_image.jpg') }}" alt="Photo de profil">
                                    </div>
                                </div>
                            </div>
                            <!-- end row -->
