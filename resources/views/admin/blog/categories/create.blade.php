    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Ajouter une catégorie</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Nouvelle catégorie de blog</h4>
                        ...
                        <form method="post" action="{{ route('admin.blog.category.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <small class="text-muted">L'image est facultative</small>
                                    @error('image')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    <div class="mt-2">
                                        <img id="showImage" class="rounded" src="{{ url('upload/no_image.jpg') }}" alt="Image de catégorie" width="200">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-10 offset-sm-2">
                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Créer la catégorie</button>
